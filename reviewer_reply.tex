...
\end{point}
\begin{reply}
This comes out from our results. The clarification has been added.
\end{reply}
...
The calculation have been performed only for ideal paralstonite structure CaBa(CO3)2. The reference is added, and the conclusion is rephrased.
 Th sentence about effect of Sr is deleted.
\end{reply}
...
\end{point}
\begin{reply}
The consideration has been added.
\end{reply}
...
\end{point}
\begin{reply}
The discussion has been added and the text is made consistent with Figure 9.
\end{reply}
